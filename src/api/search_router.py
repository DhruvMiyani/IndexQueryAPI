...
Handles vector indexing and kNN search operations.
"""
...
from .dependencies import get_search_service, get_index_service

router = APIRouter(prefix="/libraries/{library_id}", tags=["search", "indexing"])
